...
| # | Plan | Status | Touches |
| --- | --- | --- | --- |
| 03 | [Info-screen additional alerts](./03-info-screen-additional-alerts.md) | ✅ done 2026-07-25 (`f0494eb`) — pending move to `completed/` | `lilygos3-info-screen.yaml`, HA templates |
| 04 | [CapiBridge WiFi reconnect fix](./04-capibridge-wifi-reconnect-fix.md) | ✅ resolved 2026-07-28 — upstream had fixed the bug; gateway reflashed with stock latest + own config, works. Hardening branch kept as fallback. Pending move to `completed/` | `../CapiBridge` |
...
| 06 | [Info-screen battery reporting](./06-info-screen-battery-reporting-improvements.md) | ⬜ documented 2026-07-29 — seed-republish (fix #1) already implemented; spike-seed / charging-hysteresis / monotonic-% deferred | `lilygos3-info-screen.yaml` |
